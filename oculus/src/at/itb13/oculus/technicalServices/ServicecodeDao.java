...
public class ServicecodeDao {
	...
	private static final Log log = LogFactory.getLog(ServicecodeDao.class);
	...
	public void attachDirty(Servicecode instance) {
		log.debug("attaching dirty Servicecode instance");
		try {
	...
	public void attachClean(Servicecode instance) {
		log.debug("attaching clean Servicecode instance");
		try {
	...
	public void delete(Servicecode persistentInstance) {
		log.debug("deleting Servicecode instance");
		try {
	...
	public List<Servicecode> findByExample(Servicecode instance) {
		log.debug("finding Servicecode instance by example");
		try {
