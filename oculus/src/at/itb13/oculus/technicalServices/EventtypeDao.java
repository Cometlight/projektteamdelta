...
public class EventtypeDao {
	...
	private static final Logger logger = LogManager.getLogger(EventtypeDao.class.getName());
	...
	public void persist(Eventtype transientInstance) {
		logger.debug("persisting Eventtype instance");
		try {
	...
	public void attachDirty(Eventtype instance) {
		logger.debug("attaching dirty Eventtype instance");
		try {
	...
	public void attachClean(Eventtype instance) {
		logger.debug("attaching clean Eventtype instance");
		try {
	...
	public void delete(Eventtype persistentInstance) {
		logger.debug("deleting Eventtype instance");
		try {
	...
	public Eventtype merge(Eventtype detachedInstance) {
		logger.debug("merging Eventtype instance");
		try {
	...
	public Eventtype findById(java.lang.Integer id) {
		logger.debug("getting Eventtype instance with id: " + id);
		try {
	...
	public List<Eventtype> findByExample(Eventtype instance) {
		logger.debug("finding Eventtype instance by example");
		try {
