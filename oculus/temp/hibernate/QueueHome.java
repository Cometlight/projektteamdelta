...
public class QueueHome {
	...
	public void attachDirty(Queue instance) {
		log.debug("attaching dirty Queue instance");
		try {
	...
	public void attachClean(Queue instance) {
		log.debug("attaching clean Queue instance");
		try {
	...
	public void delete(Queue persistentInstance) {
		log.debug("deleting Queue instance");
		try {
	...
	public List<Queue> findByExample(Queue instance) {
		log.debug("finding Queue instance by example");
		try {
