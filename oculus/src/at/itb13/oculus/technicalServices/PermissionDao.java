...
public class PermissionDao {
	...
	private static final Logger logger = LogManager.getLogger(PermissionDao.class.getName());
	...
	public void persist(Permission transientInstance) {
		logger.debug("persisting Permission instance");
		try {
	...
	public void attachDirty(Permission instance) {
		logger.debug("attaching dirty Permission instance");
		try {
	...
	public void attachClean(Permission instance) {
		logger.debug("attaching clean Permission instance");
		try {
	...
	public Permission merge(Permission detachedInstance) {
		logger.debug("merging Permission instance");
		try {
			Permission result = (Permission) sessionFactory.getCurrentSession()
	...
	public Permission findById(java.lang.Integer id) {
		logger.debug("getting Permission instance with id: " + id);
		try {
			Permission instance = (Permission) sessionFactory
	...
	public List<Permission> findByExample(Permission instance) {
		logger.debug("finding Permission instance by example");
		try {
